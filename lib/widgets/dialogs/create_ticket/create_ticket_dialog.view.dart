      ...
      builder: (context1, model, child) {
        return Dialog(
          ...
          child: Container(
            ...
            constraints: BoxConstraints(maxHeight: MediaQuery.of(context1).size.height * 0.7),
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: Theme.of(context1).textTheme.titleLarge?.copyWith(color: AppColors.black, fontWeight: FontWeight.bold),
                            ),
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.of(context1).pop(DialogResponse(confirmed: false));
                          model.onCancel();
                        },
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CommonTextField(
                            ...
                            maxLines: 4,
                            validator: CommonValidators.required(LanguageService.get('please_describe_the_problem')),
                          ...
                          CommonTextField(
                            ...
                            validator: CommonValidators.required('${LanguageService.get('error_code')} ${LanguageService.get('required')}'),
                            contentPadding: EdgeInsets.symmetric(horizontal: 12, vertical: 14),
                          ),
                          const SizedBox(height: 16),
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                child: DottedBorder(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(Icons.add_rounded, size: 24, color: model.attachmentsError != null ? AppColors.error : AppColors.black),
                                        const SizedBox(width: 8),
                                        Text(
                                          LanguageService.get('upload_media'),
                                          style: TextStyle(
                                            color: model.attachmentsError != null ? AppColors.error : AppColors.black,
                                            fontSize: 16,
                              ...
                              if (model.attachmentsError != null) ...[
                                ...
                                Text(model.attachmentsError!, style: TextStyle(color: AppColors.error, fontSize: 12)),
                              ],
                            ],
                          ),
                          ...
                          CommonTextField(
                            ...
                            maxLines: 3,
                            validator: CommonValidators.required('${LanguageService.get('additional_notes')} ${LanguageService.get('required')}'),
                          ),
                ...
                // Action Buttons
                Padding(
                  padding: EdgeInsets.only(left: AppSizes.v16, right: AppSizes.v16, bottom: AppSizes.v16),
                  child: Row(
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: Text(LanguageService.get('cancel'), style: TextStyle(color: AppColors.textSecondary, fontWeight: FontWeight.w600)),
                        ),
                      ),

...
class CreateGroupChatViewModel extends ReactiveViewModel {
  ...
  Future<void> createGroupChat() async {
    if (_selectedEmployees.isEmpty) {
      Fluttertoast.showToast(msg: LanguageService.get("please_select_employees"));
      return;
    }

    if (groupNameController.text.trim().isEmpty) {
      Fluttertoast.showToast(msg: LanguageService.get("please_enter_group_name"));
      return;
    }
    ...
    try {
            ...
            try {
              ...
              if (e is DioException) {
                ...
                return Left<Failure, String>(
                    Failure(e.response?.data?['message'] ?? LanguageService.get("something_went_wrong")));
              }
              AppLogger.error("Error creating chat: $e");
              return Left<Failure, String>(Failure(LanguageService.get("unexpected_error_occurred")));
            }
          },
        ),
      );
      ...
      if (response?.data != null) {
        ...
        result.fold(
            ...
            Fluttertoast.showToast(msg: LanguageService.get("group_chat_created_successfully"));
      ...
      Fluttertoast.showToast(msg: LanguageService.get("failed_to_create_group_chat"));
    } finally {
      setBusy(false);
    }
  }

...
class _MachineRecordsViewState extends State<MachineRecordsView>
    ...
    if (query.isEmpty) {
      ...
      _filteredMachines =
          _machines.where((machine) {
            ...
            return machine.machineName?.toLowerCase().contains(searchLower) ==
                    true ||
                machine.modelNumber?.toLowerCase().contains(searchLower) ==
                    true ||
                machine.machineType?.toLowerCase().contains(searchLower) ==
                    true ||
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                _searchController.text.isNotEmpty
                    ? 'no_machines_found_search'.lang
                    : 'no_machines_found'.lang,
                style: TextStyle(
                  color: AppColors.textGray,
                  fontSize: 16,
  ...
  Widget _buildShimmerList() {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: List.generate(6, (index) => _buildMachineCardShimmer()),
        ),
      ),
    );
  }

...
class MachinesListViewAttributes {
  ...
  @override
  int get hashCode {
    return processorId.hashCode ^
    organizationId.hashCode ^
    title.hashCode ^
    showAddButton.hashCode ^
    showFilterButton.hashCode;
  }
}
    ...
    return ViewModelBuilder<MachinesListViewModel>.reactive(
      ...
      builder: (
        ...
        return Scaffold(
          ...
          floatingActionButton: widget.attributes.showAddButton && getUser().organizationType == OrganizationType.manufacturer
              ? FloatingActionButton(
            onPressed: () => widget.attributes.processorId.isEmpty &&
                widget.attributes.organizationId.isEmpty
    ...
    return CustomScrollView(
      slivers: [
        ...
        if (model.machines.isEmpty)
          if (widget.attributes.organizationId.isNotEmpty || widget.attributes.processorId.isNotEmpty)
            SliverFillRemaining(
              child: _buildAssignMachine(context, model),
            )
          else
            SliverFillRemaining(
              child: _buildEmptyState(context, model),
            )
        else
          SliverList(
      ...
      actions: [
        ...
        if (widget.attributes.showFilterButton)
          IconButton(
            ...
            onPressed: () => _showFilterSheet(context, model),
          ),
      ],
    );
  }
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            hint: Text(
              LanguageService.get("all_statuses"),
            ),
            isExpanded: true,
            icon: Icon(Icons.keyboard_arrow_down, color: AppColors.primary),
            dropdownColor: AppColors.white,
            items: model.statusOptions.map((String status) {
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            icon: Icon(Icons.keyboard_arrow_down, color: AppColors.primary),
            dropdownColor: AppColors.white,
            items: model.departments.map((String department) {
              return DropdownMenuItem<String>(
                value: department,
...
class ExpandableOrganizationHeader extends StatefulWidget {
  ...
  const ExpandableOrganizationHeader({
    super.key,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (details.language != null)
                              _buildDetailRow(context, Icons.language, LanguageService.get("language"), details.language),
                          ],
                        ),
                      ),
                    ],

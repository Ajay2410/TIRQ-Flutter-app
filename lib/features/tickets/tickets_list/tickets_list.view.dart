...
class _TicketsListViewState extends State<TicketsListView>
  ...
  final Set<String> _expiredTicketIds =
      {}; // Track which tickets have already triggered refresh
                            ...
                            Row(
                              children: [
                                if (ticket.status == "On Hold")
                                  _buildCountdownTimer(ticket, model),
                                SizedBox(width: 10),
                                Container(
                                  padding: EdgeInsets.symmetric(
                  ...
                  if (ticket.errorCode != null && ticket.errorCode != "") ...[
                    Expanded(
                      child: InfoColumn(
                        ...
                        value:
                            ticket.errorCode == null || ticket.errorCode == ""
                                ? "-"
                                : ticket.errorCode ?? '-',
                      ),
                    ),
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: ticket.problem ?? ticket.notes ?? "-",
                              style: TextStyle(
                                fontSize: 11,
                                color: AppColors.textGrey,
                              ),
